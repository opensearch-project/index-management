...
object SMActions {
     ...
     */
    const val EXPLAIN_SM_ACTION_NAME = "cluster:admin/opensearch/snapshot_management/explain"
    val EXPLAIN_SM_ACTION_TYPE = ActionType(EXPLAIN_SM_ACTION_NAME, ::ExplainSMPolicyResponse)

    /**
     * [TransportStartSMAction]
     */
    const val START_SM_ACTION_NAME = "cluster:admin/opensearch/snapshot_management/start"
    val START_SM_ACTION_TYPE = ActionType(START_SM_ACTION_NAME, ::AcknowledgedResponse)

    /**
     * [TransportStopSMAction]
     */
    const val STOP_SM_ACTION_NAME = "cluster:admin/opensearch/snapshot_management/stop"
    val STOP_SM_ACTION_TYPE = ActionType(STOP_SM_ACTION_NAME, ::AcknowledgedResponse)

    /**
     * [TransportExecuteSMAction]
     */
    const val EXECUTE_SM_ACTION_NAME = "cluster:admin/opensearch/snapshot_management/execute"
    val EXECUTE_SM_ACTION_TYPE = ActionType(EXECUTE_SM_ACTION_NAME, ::ExecuteSMResponse)
}
