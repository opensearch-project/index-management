...
class RollupSettings {
    companion object {
        ...
        val ROLLUP_ENABLED: Setting<Boolean> =
            Setting.boolSetting(
        ...
        val ROLLUP_SEARCH_ENABLED: Setting<Boolean> =
            Setting.boolSetting(
        ...
        val ROLLUP_INDEX: Setting<Boolean> =
            Setting.boolSetting(
        ...
        val ROLLUP_INGEST_BACKOFF_MILLIS: Setting<TimeValue> =
        ...
        val ROLLUP_INGEST_BACKOFF_COUNT: Setting<Int> =
            Setting.intSetting(
        ...
        val ROLLUP_SEARCH_BACKOFF_MILLIS: Setting<TimeValue> =
            Setting.positiveTimeSetting(
        ...
        val ROLLUP_SEARCH_BACKOFF_COUNT: Setting<Int> =
            Setting.intSetting(
        ...
        val ROLLUP_SEARCH_ALL_JOBS: Setting<Boolean> =
            Setting.boolSetting(
