...
fun sumAggregation(): AggregationBuilder =
    AggregationBuilders.sum(
        OpenSearchRestTestCase.randomAlphaOfLength(10),
    ).field(OpenSearchRestTestCase.randomAlphaOfLength(10))

fun maxAggregation(): AggregationBuilder =
    AggregationBuilders.max(
        OpenSearchRestTestCase.randomAlphaOfLength(10),
    ).field(OpenSearchRestTestCase.randomAlphaOfLength(10))

fun minAggregation(): AggregationBuilder =
    AggregationBuilders.min(
        OpenSearchRestTestCase.randomAlphaOfLength(10),
    ).field(OpenSearchRestTestCase.randomAlphaOfLength(10))

fun valueCountAggregation(): AggregationBuilder =
    AggregationBuilders.count(
        OpenSearchRestTestCase.randomAlphaOfLength(10),
    ).field(OpenSearchRestTestCase.randomAlphaOfLength(10))

fun avgAggregation(): AggregationBuilder =
...
fun TransformMetadata.toJsonString(params: ToXContent.Params = ToXContent.EMPTY_PARAMS): String =
    this.toXContent(XContentFactory.jsonBuilder(), params)
        .string()
